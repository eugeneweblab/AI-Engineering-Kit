...
STACK_SIGNALS: list[dict] = [
    ...
    {"when": "manage.py|**/manage.py", "means": "Django application",
     "docs": ["django/01-version-support", "django/02-architecture", "django/03-settings"]},
    {"when": "settings.py|**/settings.py|**/settings/base.py", "means": "Django settings module",
     "docs": ["django/03-settings", "django/06-security", "django/09-deployment"]},
    {"when": "**/wagtail_hooks.py|**/wagtail_hooks/*.py|home/templates/home/home_page.html|**/home/templates/home/home_page.html",
     "means": "Wagtail CMS application",
     "docs": ["wagtail/01-version-compatibility", "wagtail/02-architecture", "wagtail/06-permissions"]},
...
PROBES: list[tuple[str, str]] = [
    ...
    ("cms/wagtail_hooks.py", "Wagtail"),
    ("home/templates/home/home_page.html", "Wagtail"),
