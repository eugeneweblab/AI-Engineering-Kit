...
order: 4
status: ready
tags: [woocommerce, product-management, update_post_meta, WC_Product_Simple, set_regular_price, set_name, set_stock_quantity, set_manage_stock, manages, creates, products]
