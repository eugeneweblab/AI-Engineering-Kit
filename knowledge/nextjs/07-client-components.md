---
id: nextjs/07-client-components
topic: nextjs
...
order: 7
status: ready
tags: [nextjs, client-components, SearchBox, setQuery, useState, useEffect, ProductList, useTransition, interactivity, client-side, state]
