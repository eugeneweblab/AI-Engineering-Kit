...
order: 20
status: ready
tags: [postgresql, vacuum, VACUUM, pg_repack, pg_stat_user_tables, autovacuum_vacuum_scale_factor, autovacuum_freeze_max_age, idle_in_transaction_session_timeout, autovacuum, tuning, index]
