...
order: 28
status: ready
tags: [mysql, architecture, sync_binlog, innodb_flush_log_at_trx_commit, COMMIT, Seconds_Behind_Source, MyISAM, innodb_buffer_pool_size, durability, buffer, topology]
