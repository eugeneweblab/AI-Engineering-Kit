...
order: 2
status: ready
tags: [mysql, configuration, my.cnf, innodb_buffer_pool_size, sql_mode, STRICT_TRANS_TABLES, max_connections, innodb_flush_log_at_trx_commit, buffer, durability, pool]
